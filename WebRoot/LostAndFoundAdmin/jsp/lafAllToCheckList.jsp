...
<body>
	...
	<header class="am-topbar am-topbar-fixed-top">
		...
		<div class="contain">
			<ul class="am-nav am-navbar-nav am-navbar-left">
				...
				<li><h4 class="page-title">待审核启示</h4></li>
			</ul>
			...
			<div class="card-box">
				...
				<div class="am-g">
					...
					<div class="am-u-sm-12 am-u-md-3">
						<form action="laf_searchToCheckInfo.hnuc" method="get">
												...
												<div class="am-btn-toolbar">
													<div class="am-btn-group am-btn-group-xs">
														<button
															...
															<a href="${pageContext.request.contextPath }/laf_editInfo.hnuc?lafId=${laf.laf_id }" target="_blank">
														...
														<button
															...
															<a href="javascript:;"
															onclick="return checkDel('${pageContext.request.contextPath }/laf_delInfoById.hnuc?lafId=${laf.laf_id }');">
																<span class="am-icon-trash-o"></span> 删除
															</a>
														</button>
														<button
														...
														<button
															class="am-btn am-btn-default am-btn-xs am-text-secondary">
															<a href="${pageContext.request.contextPath }/laf_letInfoBeTrue.hnuc?lafId=${laf.laf_id }">
																<span class="am-icon-pencil-square-o"></span> 通过
															</a>
														</button>
													</div>
												</div>
	...
	<script src='${pageContext.request.contextPath }/plugins/layer-v2.4/layer/layer.js'></script>
