  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-file"></span> 失物招领信息管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="admin-table.jsp"><span class="am-icon-table"></span> 有效信息</a></li>
            <li><a href="admin-table.jsp"><span class="am-icon-table"></span> 待审核</a></li>
            <li><a href="admin-table.jsp"><span class="am-icon-table"></span> 已失效</a></li>
          </ul>
        </li>
